# Graph Report - AndroProject_Dev  (2026-08-11)

## Corpus Check
- 136 files · ~173,424 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 897 nodes · 1493 edges · 70 communities (53 shown, 17 thin omitted)
...
Cohesion: 0.21
Nodes (15): QuickAction(), QuickActionProps, ThemeProps, ArchivosView(), ConfigView(), AntivirusPanel(), CurarView(), ScreenshotPanel() (+7 more)
...
Cohesion: 0.05
Nodes (49): inter, metadata, AppShell(), AppShellProps, Header(), HeaderProps, groups, NavItemDef (+41 more)
...
Cohesion: 0.06
Nodes (34): deduplicate(), detect(), DeviceInfo, execAsync, fetchDeviceDetails(), listDevices(), ParsedDevice, actionSchemas (+26 more)
...
Cohesion: 0.22
Nodes (8): Button(), ButtonProps, ButtonSize, ButtonVariant, sizeClasses, variantClasses, OptimizerView(), OptimizerViewProps
...
Cohesion: 0.14
Nodes (15): Page(), SidebarProps, AppsViewProps, CurarViewProps, APP_COLORS, AppsFilterDash, DashboardView(), DashboardViewProps (+7 more)
...
Cohesion: 0.31
Nodes (8): clamp(), clamp01(), DeviceFrame(), DeviceFrameProps, ZoomState, StreamMode, useDeviceStream(), UseDeviceStreamResult
...
Cohesion: 0.18
Nodes (6): DeviceInfoPanel(), DeviceInfoPanelProps, EmptyState(), EmptyStateProps, SplitDivider(), SplitDividerProps
...
Cohesion: 0.21
Nodes (7): ViewShell(), ViewShellProps, ConfigViewProps, FlasherView(), FlasherViewProps, PARTITIONS, ThemeColors
...
- **Why does `DeviceInfo` connect `ThemeProvider.tsx` to `DeviceFrame.tsx`, `index.ts`, `DeviceInfo`, `DeviceInfoPanel.tsx`, `CommandResult`, `types.ts`, `ConfigView.tsx`, `cn`, `page.tsx`, `AppsView.tsx`?**
