...
## Corpus Check
- 129 files · ~169,243 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 821 nodes · 1346 edges · 71 communities (52 shown, 19 thin omitted)
...
Cohesion: 0.30
Nodes (13): Page(), ArchivosView(), ConfigView(), AntivirusPanel(), CurarView(), ScreenshotPanel(), ShellLine, ToolsView() (+5 more)
...
Cohesion: 0.07
Nodes (37): inter, metadata, AppShell(), AppShellProps, Header(), HeaderProps, groups, NavItemDef (+29 more)
...
Cohesion: 0.17
Nodes (12): Button(), ButtonProps, ButtonSize, ButtonVariant, sizeClasses, variantClasses, ViewShell(), ViewShellProps (+4 more)
...
Cohesion: 0.22
Nodes (5): APP_COLORS, AppsFilterDash, DashboardView(), getAppColor(), RunningApp
...
Cohesion: 0.16
Nodes (13): CurarViewProps, OptimizerViewProps, ProjectionView(), ProjectionViewProps, ToolsViewProps, DeviceInfo, UseDevicePollingResult, useMediaQuery() (+5 more)
...
- **Why does `DeviceInfo` connect `DeviceInfo` to `index.ts`, `DeviceFrame.tsx`, `DeviceInfoPanel.tsx`, `CommandResult`, `types.ts`, `cn`, `page.tsx`, `AppsView.tsx`, `ThemeProvider.tsx`?**
