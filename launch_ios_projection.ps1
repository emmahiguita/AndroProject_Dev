...
if ($ChromePath) {
    Start-Process chrome.exe -ArgumentList "--app=$AppUrl", "--window-size=520,1020", "--window-position=1150,40"
    Write-Host " -> Ventana de proyección desplegada con éxito." -ForegroundColor Green
} else {
